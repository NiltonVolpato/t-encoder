...
const REPORT_MAP: &[u8] = &[
    ...
    0x95, 0x08, //   Report Count (8 fields = 8 bits total)
    0x81, 0x02, //   Input (Data, Variable, Absolute)
    // --- Byte 1: Reserved byte ---
    0x95, 0x01, //   Report Count (1 field)
    0x75, 0x08, //   Report Size (8 bits)
    0x81, 0x01, //   Input (Constant, Array, Absolute) -> Padding byte
    // --- Bytes 2 to 7: 6-Key Rollover Array ---
    0x95, 0x06, //   Report Count (6 fields = 6 bytes)
    0x75, 0x08, //   Report Size (8 bits per key code)
    0x15, 0x00, //   Logical Minimum (0)
    0x25, 0x65, //   Logical Maximum (101 keys: 0x65 = Keyboard Application)
    0x05, 0x07, //   Usage Page (Kbrd/Keypad)
    0x19, 0x00, //   Usage Minimum (0x00: Reserved/No event)
    0x29, 0x65, //   Usage Maximum (0x65: Keyboard Application)
